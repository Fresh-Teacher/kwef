/******/ (function (modules) {
  ...
  \***************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1___default =
          /*#__PURE__*/ __webpack_require__.n(
        ...
        /* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default =
          /*#__PURE__*/ __webpack_require__.n(
        ...
        /* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_4___default =
          /*#__PURE__*/ __webpack_require__.n(
        ...
        var wpcf7cf_change_events =
          "input.wpcf7cf paste.wpcf7cf change.wpcf7cf click.wpcf7cf propertychange.wpcf7cf";
        var wpcf7cf_forms = [];
        window.wpcf7cf_dom = {};
            ...
            if (
              ...
              if ($group.prop("tagName") === "SPAN" || $group.is(":hidden")) {
                ...
                $group
                  ...
                  .trigger("wpcf7cf_show_group"); // show
              }
        ...
        Wpcf7cfForm.prototype.updateSummaryFields = function () {
          ...
          jQuery.ajax({
            url:
              wpcf7cf_global_settings.ajaxurl + "?action=wpcf7cf_get_summary",
            type: "POST",
            data: fd,
            processData: false,
            contentType: false,
        ...
        function Wpcf7cfMultistep($multistep, form) {
          ...
          multistep.$btn_next.on(
            "click.wpcf7cf_step",
            /*#__PURE__*/ _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_4___default()(
              /*#__PURE__*/ _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default.a.mark(
                function _callee() {
                  var result;
                ...
                if (!json.success) {
                  ...
                  jQuery.each(json.invalid_fields, function (index, el) {
                    if (
                      ...
                      $multistep.find('select[name="' + index + '[]"]')
                        .length ||
                      $multistep.find('textarea[name="' + index + '"]')
                        .length ||
        ...
        Wpcf7cfMultistep.prototype.moveToStep = function (step_index) {
          ...
          multistep.currentStep =
            step_index > multistep.numSteps
              ...
              : step_index < 1
              ? 1
              : step_index; // ANIMATION DISABLED FOR NOW cause it's ugly
            ...
            if (type) {
              ...
              if (type === "input") {
                ...
                if (
                  ...
                  return {}; // if multiselect, make sure to add all the values
          ...
          isConditionTrue: function isConditionTrue(values, operator) {
            ...
            for (var i = 0; i < values.length; i++) {
              ...
              var valueNumber = isFinite(parseFloat(value))
                ...
                : NaN;
              var valsAreNumbers =
                !isNaN(valueNumber) && !isNaN(testValueNumber);
